...
<head>
    ...
    <title>Insurance Companies - Agents</title>
    ...
    <div class="flex flex-col items-center px-5 sm:px-20 sm:py-10 w-full max-w-screen-xl mx-auto space-y-6 pb-[65px]">
        ...
        <div class="w-full px-5 py-3">
            <ul class="flex flex-wrap font-medium text-center text-gray-500 dark:text-gray-400 text-lg">
                ...
                <li class="me-2">
                    <a href="/insurance_companies/agents" class="inline-block px-4 py-3 text-white bg-violet-500 rounded-lg active" aria-current="page">Insurance Companies - Agents</a>
                </li>
            </ul>
        </div>
                ...
                <table class="w-full text-sm text-left text-white">
                    <thead class="text-xs uppercase">
                        <tr class="bg-violet-900">
                            <th class="sm:px-6 sm:py-4 px-4 py-2">Agent</th>
                    ...
                    <tbody>
                        @foreach ($agents as $agent)
                            <tr class="group cursor-pointer even:bg-violet-800">
                                <td class="sm:px-6 sm:py-4 px-4 py-2">{{ $agent->name }}</td>
                                <td class="sm:px-6 sm:py-4 px-4 py-2">{{ $agent->branch->name ?? '--' }}</td>
                                <td class="sm:px-6 sm:py-4 px-4 py-2">{{ $agent->company->name }}</td>
                                <td class="sm:px-6 sm:py-4 px-4 py-2 text-end text-nowrap">{{ $agent->expiry_date ?? '--' }}</td>
