                                    ...
                                    <tbody>
                                        @foreach ($tickets as $ticket)
                                            <tr class="cursor-pointer align-top">
                                                ...
                                                <td class="px-6 border-b text-center" style="min-width: 190px;">
                                                    @if ($ticket->status == 'CREATED')
                                                    ...
                                                    <a href="/ticket/{{ $ticket->id }}/edit"
                                                        ...
                                                        class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-violet-300 font-medium rounded-lg text-sm px-4 py-2.5 m-1">
