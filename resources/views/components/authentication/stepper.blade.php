<div class="flex p-5 text-sm text-blue-800 border rounded-lg">
    <ol class="space-y-8 rtl:space-x-reverse flex flex-col">
        <li class="flex items-center text-violet-700 space-x-2.5 rtl:space-x-reverse">
            <span class="flex items-center justify-center w-8 h-8 border bg-violet-700 text-white rounded-full shrink-0">
                1
            </span>
            <span>
        ...
        <li x-bind:class="(step >= 2) ? 'text-violet-700' : 'text-gray-500'"
        ...
        <li x-bind:class="(step == 3) ? 'text-violet-700' : 'text-gray-500'"
            class="flex items-center space-x-2.5 rtl:space-x-reverse">
