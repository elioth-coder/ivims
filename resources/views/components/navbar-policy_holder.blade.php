<nav class="bg-violet-700 border-b border-violet-600 z-10 flex text-white h-[70px] fixed top-0 w-full">
    <div class="flex mx-auto max-w-screen-lg w-full items-center">
